...
export default function Home() {
  return (
    <main className="flex bg-stone-950 justify-center md:justify-normal">
      ...
      <div className="w-3/3 md:w-2/3 h-screen mx-[5px] grid grid-flow-row auto-rows-min auto-cols-min grid-cols-2 sm:grid-cols-3 xl:grid-flow-cols-4  overflow-scroll [&::-webkit-scrollbar]:hidden gap-y-4 pt-[8em] ">
